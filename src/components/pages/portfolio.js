...
import counter from '../assets/images/counter_Dart.jpg';
...
class Portfolio extends Component {
  ...
  render() {
    return (
        <div className="main" style={{marginTop:"56px" ,paddingTop:"2em" }}>
           ...
           {/*  {cards.map((card, i) => (
            ...
            <div className="column">
              <Card>
                ...
                <div style={{ width: '100%', textAlign: 'center' ,paddingBottom:'1rem' }}><img  alt="Web Apps" style={{width:'100px'}} src={counter}/></div>                                 
